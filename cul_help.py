def help_message():
    ...
    Commands:
        ...
        install module --use-reg <registry_url>         - Installs the specified module from the specified registry.
        ...
        update module --use-reg <registry_url>          - Updates the specified module from the specified registry.
